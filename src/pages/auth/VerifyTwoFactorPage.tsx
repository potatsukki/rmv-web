...
export function VerifyTwoFactorPage() {
  ...
  const otpInputClasses = 'label-font h-14 w-11 sm:h-16 sm:w-12 rounded-none border border-white/10 bg-white/[0.01] text-center text-xl sm:text-2xl font-black tracking-tighter text-white placeholder:text-[#5a5a60] focus-visible:border-[#FFD700]/30 focus-visible:ring-0 transition-all focus:bg-white/[0.03]';
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative mx-auto w-full max-w-md border border-white/5 bg-[#0a0a0b]/60 p-7 sm:p-10 backdrop-blur-3xl">
          <div className="mb-8 text-center">
            ...
            <h1 className="headline-font text-[clamp(1.5rem,8vw,1.75rem)] font-bold tracking-tight text-white leading-tight">Verification Required</h1>
            <p className="label-font mt-3 text-[10px] font-medium uppercase tracking-[0.2em] text-[#919097] leading-relaxed">
              {firstName ? `Hi ${firstName}, w` : 'W'}e sent a 6-digit code to <br className="sm:hidden" />
              <strong className="text-[#f5f7fa] break-all">{email}</strong>
            </p>
          </div>
