      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative mx-auto w-full max-w-md border border-white/5 bg-[#0a0a0b]/60 p-7 sm:p-10 backdrop-blur-3xl">
          <div className="mb-8 text-center">
            ...
            <h1 className="headline-font text-[clamp(1.5rem,8vw,1.75rem)] font-bold tracking-tight text-white leading-tight">Reset password</h1>
            <p className="mt-3 text-[10px] font-medium uppercase tracking-[0.2em] text-[#919097] leading-relaxed">Choose a new password for your account.</p>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-1.5">
              <Label htmlFor="newPassword" className="label-font text-[10px] font-black uppercase tracking-[0.3em] text-[#FFD700] gold-glow">
                New Password
              </Label>
