...
function overhaulForgotPasswordPage() {
    const path = 'src/pages/auth/ForgotPasswordPage.tsx';
    ...
    // Update form column
    content = content.replace(
        'className="relative z-10 flex w-full flex-1 flex-col justify-center bg-[radial-gradient(circle_at_top_left,#1a2430_0%,#0d1218_50%,#05070a_100%)] px-6 py-12 lg:w-[48%] lg:flex-none lg:px-20 xl:px-28"',
        'className="relative z-10 flex w-full flex-1 flex-col justify-center bg-black px-6 py-12 lg:w-[48%] lg:flex-none lg:px-20 xl:px-28"'
    );
...
overhaulForgotPasswordPage();
console.log('ForgotPasswordPage overhauled.');
